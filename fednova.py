...
if __name__ == "__main__":
    ...
    if not Path(f"records/{args.idx_folder}/E{epochs}/fednova").exists():
        os.makedirs(f"records/{args.idx_folder}/E{epochs}/fednova")
    
    json.dump(local_loss_record,        open(f"records/{args.idx_folder}/E{epochs}/fednova/local_loss_record.json", "w"),         cls=NumpyEncoder)
    json.dump(local_acc_bfag_record,    open(f"records/{args.idx_folder}/E{epochs}/fednova/local_acc_bfag_record.json", "w"),     cls=NumpyEncoder)
    json.dump(local_acc_afag_record,    open(f"records/{args.idx_folder}/E{epochs}/fednova/local_acc_afag_record.json", "w"),     cls=NumpyEncoder)
    json.dump(global_cfmtx_record,      open(f"records/{args.idx_folder}/E{epochs}/fednova/global_cfmtx_record.json", "w"),       cls=NumpyEncoder)
